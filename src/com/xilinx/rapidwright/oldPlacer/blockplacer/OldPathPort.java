...
/**
 * Represents endpoints on a {@link OldPath}.
 * @author clavin
 *
 */
public class OldPathPort {
	
	private SitePinInst sitePinInst;
	private OldHardMacro block;
	 ...
	 */
	public void setBlock(OldHardMacro block) {
		this.block = block;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OldPathPort other = (OldPathPort) obj;
		if (sitePinInst == null) {
