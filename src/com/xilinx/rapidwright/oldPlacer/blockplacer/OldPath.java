 ...
 *
 */
public class OldPath extends ArrayList<OldPathPort>{
	private int length;
	 ...
	 */
	public void addPin(SitePinInst p, HashMap<ModuleInst, OldHardMacro> map){
		OldPathPort pp = new OldPathPort();
		pp.setSitePinInst(p);
