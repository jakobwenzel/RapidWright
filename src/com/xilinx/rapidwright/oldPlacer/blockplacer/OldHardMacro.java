...
/**
 * This extends {@link ModuleInst} and is used by {@link OldBlockPlacer2}
 * to help calculate system cost.
 * @author clavin
 *
 */
public class OldHardMacro extends ModuleInst implements Comparable<Object> {
	
	private HashSet<Site> validSiteSet;
	
	private ArrayList<OldPortWire> connectedPortWires;
	
	private HashSet<OldPath> connectedPaths;
	...
	public OldHardMacro(ModuleInst moduleInst) {
		super(moduleInst);
		setConnectedPortWires(new ArrayList<OldPortWire>());
		connectedPaths = new HashSet<OldPath>();
	}
	 ...
	 */
	public void setTempAnchorSite(Site tempAnchorSite, HashMap<Site, OldHardMacro> currentPlacements) {
		Tile t = null;
	 ...
	 */
	public void setConnectedPortWires(ArrayList<OldPortWire> connectedPortWires) {
	 ...
	 */
	public ArrayList<OldPortWire> getConnectedPortWires() {
		return connectedPortWires;
	}

	public void addConnectedPortWire(OldPortWire wire){
		connectedPortWires.add(wire);
	}
	
	public void addConnectedPath(OldPath path){
		connectedPaths.add(path);
	}
	
	public HashSet<OldPath> getConnectedPaths(){
	 ...
	 * @return
	 */
	public boolean overlaps(OldHardMacro hm){
	...
	public int compareTo(Object other){
		return ((OldHardMacro)other).getTileSize() - getTileSize();
	}
